...
<div className={styles.cards}>
 <Card style={{ width: '20rem', height:'36rem', margin: "3%" }}>
      ...
      <Card.Body>
        <Card.Title className={styles.title}> <a className={styles.link} href="https://roaming-spoon.herokuapp.com/" target="_blank">Sneaker Forum</a></Card.Title>
        <Card.Text className={styles.cardtext}>
    ...
    <Card.Body id="card">
      <Card.Title className={styles.title}><a className={styles.link}  href="" target="_blank">The Roaming Spoon</a></Card.Title>
      <Card.Text className={styles.cardtext}>
